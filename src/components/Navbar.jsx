  ...
  return <div className="navbar py-7 flex justify-between items-center">
    ...
    <ul className={`menu flex items-center sm:gap-10 gap-4 md:static fixed left-1/2
     ...
     ${active ? "top-0 opacity-100" : "-top-10 opacity-0"}`}>
        <li>
            <a href="#" className="sm:text- text-base font-medium">Beranda</a>
        </li>
        <li>
            <a href="#" className="sm:text- text-base font-medium">Tentang</a>
        </li>
        <li>
            <a href="#" className="sm:text- text-base font-medium">Proyek</a>
        </li>
        <li>
            <a href="#" className="sm:text- text-base font-medium">Kontak</a>
        </li>
    </ul>
  </div>  
};
