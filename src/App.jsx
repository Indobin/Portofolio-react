  ...
  return (
    <>
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
        <div>
          ...
          <p className="text-base mb-6 opacity-50">
            ...
            sudah berlangsung lebih dari 4 Tahun untuk semua Bidang.
          </p>
      ...
      <div className="tentang mt-32 py-10">
        <div className="w-2/3 lg:w-3/4 mx-auto p-7 bg-zinc-800 rounded-lg">
        <img src={DataImage.HeroImage} className="w-12 rounded-md mb-10 sm:hidden" alt="" />
          <p className="text-base/loose mb-10">
            Hi, perkenalkan saya Diky Prayoga, seorang Full Stack Web Developer dan Designer untuk UI/UX Design maupun Product Digital,
             Saya percaya bahwa desain dan fungsionalitas harus berjalan beriringan, 
          ...
          <div className="flex items-center justify-between">
            <img src={DataImage.HeroImage} className="w-12 rounded-md sm:block hidden" alt="Image" />
